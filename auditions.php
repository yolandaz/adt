<div class="content-wrapper">
	...
	Send an e-mail to <a href="mailto:adt-exec@mit.edu">adt-exec@mit.edu</a> <b>before the date of auditions</b> and describe the reason for your absence. The exec board will try to schedule a make-up if possible, but <i>this is not guaranteed</i>. Please try to make the auditions date if at all possible. Thanks!</p>
</div>